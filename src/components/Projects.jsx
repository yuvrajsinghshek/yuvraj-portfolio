...
const projects = [
  {
    ...
    desc: 'Production-grade RAG chatbot for Indian citizens to get accurate cybercrime info. Engineered end-to-end system: RAG pipeline (ChromaDB + sentence-transformers), FastAPI backend, PostgreSQL database, JWT Auth, and Streamlit frontend. Fully deployed 24/7 on Railway and Streamlit Cloud.',
  ...
  },
  {
    ...
    desc: 'Architected the AI brain featuring 5 distinct persona-based agents (teacher, friend, assessment) using specialised LangChain RAG pipelines. Integrated Groq for low-latency inference and validated retrieval performance on a custom knowledge base in Supabase.',
